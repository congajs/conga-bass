...
// framework libs
const CongaProfiler = require('conga-profiler');

/**
 * The BassDataCollector collects query information from bass during a request
 */
class BassDataCollector extends CongaProfiler.Collector.DataCollectorInterface {
    /**
     ...
     */
    getTemplate() {
        return 'conga-bass:collector/bass.html.twig';
    }
...
module.exports = BassDataCollector;