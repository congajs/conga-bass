...
class ManagerRequestProxy extends RequestProxy {
    ...
    mapToModel(metadata, data, populate, cb) {
        const stopwatch = this.stopwatch('mapToModel');
    ...
    mapDataToModel(metadata, document, cb, walkRecursive) {
        const stopwatch = this.stopwatch('mapDataToModel');
    ...
    mapDataToModels(metadata, document, cb, walk) {
        const stopwatch = this.stopwatch('mapDataToModels');
    ...
    mapModelToData(metadata, model, cb) {
        const stopwatch = this.stopwatch('mapModelToData');
    ...
    updateBy(name, criteria, data) {
        ...
        const stopwatch = this.stopwatch('updateBy');
        return this.promise(
    ...
    removeBy(name, criteria) {
        ...
        const stopwatch = this.stopwatch('removeBy');
        return this.promise(
    ...
    find(name, id) {
        ...
        const stopwatch = this.stopwatch('find');
        return this.promise(
    ...
    findByQuery(name, query) {
        ...
        const stopwatch = this.stopwatch('findByQuery');
        return this.promise(
    ...
    findCountByQuery(name, query) {
        ...
        const stopwatch = this.stopwatch('findCountByQuery');
        return this.promise(
    ...
    findBy(name, criteria, sort, skip, limit) {
        ...
        const stopwatch = this.stopwatch('findBy');
        return this.promise(
    ...
    findWhereIn(name, field, values, sort, limit) {
        ...
        const stopwatch = this.stopwatch('findWhereIn');
        return this.promise(
    ...
    findCountBy(name, criteria) {
        ...
        const stopwatch = this.stopwatch('findCountBy');
        return this.promise(
    ...
    findOneBy(name, criteria, sort) {
        ...
        const stopwatch = this.stopwatch('findOneBy');
        return this.promise(
